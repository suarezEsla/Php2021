...
if ($_SERVER['REQUEST_METHOD'] == "GET" ){
    ...
    if ( isset($_GET['orden'])){
        switch ($_GET['orden']) {
            ...
            case "Borrar"   : accionBorrar($_GET['producto_no']); break;
            case "Modificar": accionModificar($_GET['producto_no']); break;
            case "Detalles" : accionDetalles ($_GET['producto_no']);break;
